...
* [下載腳本](https://github.com/samwhelp/fedora-adjustment/blob/main/core/iso/boot-iso/boot-iso-by-grub/demo-boot-fedora-42-iso/)
...
> 例如：要找「Kde Plasma」可以直接到「[https://download.fedoraproject.org/pub/fedora/linux/releases/42/KDE/x86_64/iso/](https://download.fedoraproject.org/pub/fedora/linux/releases/42/KDE/x86_64/iso/)」，
...
https://download.fedoraproject.org/pub/fedora/linux/releases/42/Spins/x86_64/iso/Fedora-KDE-Mobile-Live-42-1.1.x86_64.iso
...
| [Kde Mobile](https://fedoraproject.org/spins/kde-mobile/) | [Download](https://fedoraproject.org/spins/kde-mobile/download) |
